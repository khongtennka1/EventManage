                ...
                <div class="col-xl-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="apex-charts" data-colors='["--bs-primary", "--bs-warning"]' id="area-chart"
                                dir="ltr"></div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <li class="list-group-item py-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="align-self-center overflow-hidden me-auto">
                                                        <div>
                                                            <h5 class="font-size-14 text-truncate"><a
                                                                    href="javascript: void(0);" class="text-dark">Riding
                                                                    bike on road</a></h5>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="font-size-14 mb-1">Keith McCoy <small
                                                        class="text-muted float-end">12
                                                        Aug</small></h5>
                                                <p class="text-muted">Donec posuere vulputate arcu. phasellus accumsan
                                                    cursus
                                                    velit</p>
                                                <div>
                                                    <a href="javascript: void(0);" class="text-success"><i
                                ...
                                <ul class="verti-timeline list-unstyled">
                                    <li class="event-list active">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    Posted <span class="fw-semibold">Beautiful Day with Friends</span>
                                                    blog... <a href="javascript: void(0);">View</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                        href="javascript: void(0);" class="text-dark">Beautiful Day with
                                                        Friends</a></h5>
                                                <p class="text-muted mb-0">10 Nov, 2020</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('assets/images/small/img-6.jpg') }}" alt=""
                                                    class="avatar-md h-auto d-block rounded"></td>
                                            <td>
                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                        href="javascript: void(0);" class="text-dark">Drawing a
                                                        sketch</a></h5>
                                                <p class="text-muted mb-0">02 Nov, 2020</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('assets/images/small/img-1.jpg') }}" alt=""
                                                    class="avatar-md h-auto d-block rounded"></td>
                                            <td>
                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                        href="javascript: void(0);" class="text-dark">Riding bike on
                                                        road</a></h5>
                                                <p class="text-muted mb-0">24 Oct, 2020</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('assets/images/small/img-2.jpg') }}" alt=""
                                                    class="avatar-md h-auto d-block rounded"></td>
                                            <td>
                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                        href="javascript: void(0);" class="text-dark">Project discussion
                                                        with team</a></h5>
