            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('dashboard_saas') }}" key="t-saas">Saas</a></li>
                        <li><a href="" key="t-crypto">Crypto</a></li>
                        <li><a href="{{ route('dashboard_blog') }}" key="t-blog">Blog</a></li>
                        <li><a href="{{ route('dashboard_job') }}" key="t-jobs">Jobs</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ route('layouts_light_sidebar') }}" key="t-light-sidebar">Light Sidebar</a></li>
                                <li><a href="{{ route('layouts_compact_sidebar') }}" key="t-compact-sidebar">Compact Sidebar</a></li>
                                <li><a href="{{ route('layouts_icon_sidebar') }}" key="t-icon-sidebar">Icon Sidebar</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ route('layouts_horizontal') }}" key="t-horizontal">Horizontal</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('calendar') }}" key="t-tui-calendar">TUI Calendar</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ route('apps_filemanager') }}" class="waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('ecommerce_products') }}" key="t-products">Products</a></li>
                        <li><a href="{{ route('ecommerce_product_detail') }}" key="t-product-detail">Product Detail</a></li>
                        <li><a href="{{ route('ecommerce_cart') }}" key="t-cart">Cart</a></li>
                        <li><a href="{{ route('ecommerce_checkout') }}" key="t-checkout">Checkout</a></li>
                        <li><a href="{{ route('ecommerce_add_product') }}" key="t-add-product">Add Product</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('email_inbox') }}" key="t-inbox">Inbox</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('contacts_grid') }}" key="t-user-grid">Users Grid</a></li>
                        <li><a href="{{ route('contacts_list') }}" key="t-user-list">Users List</a></li>
                        <li><a href="{{ route('admin_profile') }}" key="t-profile">Profile</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('blog_list') }}" key="t-blog-list">Blog List</a></li>
                        <li><a href="{{ route('blog_grid') }}" key="t-blog-grid">Blog Grid</a></li>
                        <li><a href="{{ route('blog_details') }}" key="t-blog-details">Blog Details</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ route('candidate_list') }}" key="t-list">List</a></li>
                                <li><a href="{{ route('candidate_overview') }}" key="t-overview">Overview</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('login.login') }}" key="t-login">Login</a></li>
                        <li><a href="{{ route('register.register') }}" key="t-register">Register</a></li>
                        <li><a href="{{ route('login.forgot_password') }}" key="t-recover-password">Recover Password</a></li>
