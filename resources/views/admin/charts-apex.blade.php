                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="line_chart_datalabel" data-colors='["--bs-primary", "--bs-success"]'
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="line_chart_dashed"
                                        data-colors='["--bs-primary", "--bs-danger", "--bs-success"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="spline_area" data-colors='["--bs-primary", "--bs-success"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="column_chart" data-colors='["--bs-success","--bs-primary", "--bs-danger"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="dumbbell_column_charts" data-colors='["--bs-primary", "--bs-success"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="range_area_chart" data-colors='["--bs-primary"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="dumbbell_timeline_charts" data-colors='["--bs-primary", "--bs-success"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="funnel_charts" data-colors='["--bs-primary"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="mixed_chart" data-colors='["--bs-danger","--bs-primary", "--bs-success"]'
                                        class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card-->
                        </div>
