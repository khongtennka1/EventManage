                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="card p-1 border shadow-none">
                                                            <div class="p-3">
                                                                <h5><a href="{{ route('blog_details') }}" class="text-dark">Beautiful
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="card p-1 border shadow-none">
                                                            <div class="p-3">
                                                                <h5><a href="{{ route('blog_details') }}" class="text-dark">Drawing a
                                                                        sketch</a></h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="card p-1 border shadow-none">
                                                            <div class="p-3">
                                                                <h5><a href="{{ route('blog_details') }}" class="text-dark">Riding bike
                                                                        on road</a></h5>
                                                                <p class="text-muted mb-0">10 Apr, 2020</p>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="card p-1 border shadow-none">
                                                            <div class="p-3">
                                                                <h5><a href="{{ route('blog_details') }}" class="text-dark">Project
                                        ...
                                        <div class="col-xl-8">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <div class="list-group list-group-flush">
                                                    <a href="{{ route('blog_details') }}" class="list-group-item text-muted"><i
                                                    ...
                                                    <a href="{{ route('blog_details') }}" class="list-group-item text-muted"><i
                                                            class="mdi mdi-circle-medium me-1"></i> Project discussion
                                                        with team</a>
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-2 widget-tag">
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Design</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Development</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Business</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Project</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Travel</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Lifestyle</a></div>
                                    <div><a href="javascript: void(0);"
                                            class="badge bg-light font-size-12">Photography</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
