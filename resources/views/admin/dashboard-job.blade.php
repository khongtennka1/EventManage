                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <a href="javascript:void(0);" class="btn btn-primary"><i
                                    class="bx bx-plus align-middle"></i> Add New Jobs</a>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
                    ...
                    <div class="card mini-stats-wid">
                        ...
                        <div class="card-body border-top py-3">
                            <p class="mb-0"> <span class="badge badge-soft-danger me-1"><i
                                        class="bx bx-trending-down align-bottom me-1"></i> 20.63%</span> Decrease last
                                month</p>
                        </div>
                    </div>
                </div><!--end col-->
                                    ...
                                    <div class="carousel-item active" data-bs-interval="3000">
                                        <div class="bg-light p-3 d-flex mb-3 rounded">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> Germany</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                        ...
                                        <div class="bg-light p-3 d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> Cambodia</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                                    <button class="btn btn-soft-primary" type="button"
                                    ...
                                    <div class="carousel-item" data-bs-interval="3000">
                                        <div class="bg-light p-3 d-flex mb-3 rounded">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> Australia</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                                    <button class="btn btn-soft-primary" type="button"
                                        ...
                                        <div class="bg-light p-3 d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="font-size-15 mb-2"><a href="candidate-overview.html"
                                                        ...
                                                        class="badge badge-soft-info">Freelance</span></h5>
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> Belgium</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                                    <button class="btn btn-soft-primary" type="button"
                                    ...
                                    <div class="carousel-item" data-bs-interval="3000">
                                        <div class="bg-light p-3 d-flex mb-3 rounded">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> Syria</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                                    <button class="btn btn-soft-primary" type="button"
                                        ...
                                        <div class="bg-light p-3 d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted"><i
                                                        class="bx bx-map text-body align-middle"></i> San Marino</p>
                                            </div>
                                            <div>
                                                <div class="dropdown">
                                                    <button class="btn btn-soft-primary" type="button"
                ...
                <div class="col-lg-2">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex">
                                <p class="mb-0 flex-grow-1 text-muted"><i class="bx bx-map text-body"></i> California
                                </p>
                                ...
                                <ul class="verti-timeline list-unstyled">
                                    ...
                                    <li class="event-list">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    Your subscription expires today <a href="javascript: void(0);">Renew
                                                        Now</a>
                        ...
                        <div class="card-body">
                            ...
                            <div data-simplebar style="max-height: 376px;">
                                <div class="vstack gap-4">
                                    <div class="d-flex">
                                        <img src="assets/images/companies/wechat.svg" alt="" height="40"
                                            class="rounded">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="job-details.html">View Details</a>
                                                </li>
                                    ...
                                    <div class="d-flex">
                                        <img src="assets/images/companies/airbnb.svg" alt="" height="40"
                                            class="rounded">
                                        <div class="ms-2 flex-grow-1">
                                            <h6 class="mb-1 font-size-15"><a href="job-details.html"
                                ...
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/companies/mailchimp.svg') }}" alt="" height="40"
                                        class="rounded">
                                    <div class="ms-2 flex-grow-1">
                                        <h6 class="mb-1 font-size-15"><a href="job-details.html"
                                                class="text-body">Marketing Director</a></h6>
                                ...
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/companies/spotify.svg') }}" alt="" height="40"
                                        class="rounded">
                                    <div class="ms-2 flex-grow-1">
                                        <h6 class="mb-1 font-size-15"><a href="job-details.html"
                                ...
                                <div class="d-flex">
                                    <img src="{{ asset('assets/images/companies/reddit.svg') }}" alt="" height="40"
                                        class="rounded">
                                    <div class="ms-2 flex-grow-1">
                                        <h6 class="mb-1 font-size-15"><a href="job-details.html"
