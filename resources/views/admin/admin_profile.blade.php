...
<main id="main" class="main">
    <div class="pagetitle" style="margin-left: -350px; margin-top: -80px;">
      <h1>Profile</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section profile" style="margin-left: -350px;">
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ asset('storage/' . $user->Avatar) }}" alt="Profile" class="rounded-circle" style="width: 100px; height: 100px;">
              <h2>{{ $user->UserName }}</h2>
              <h3>Web Designer</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="{{ route('adminProfileHandler', $user->UserID) }}" method="Post">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <div class="pt-2">
                          <input type="file" name="Avatar" class="form-control-file" id="profileImage">
                          {{-- <input type="checkbox" name="removeAvatar"> Remove --}}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="UserName" class="form-control" id="about" value="{{ $user->UserName }}">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  <form action="{{ route('adminChangePassword', $user->UserID) }}" method="Post">
                    @csrf
                    <div class="row mb-3">
