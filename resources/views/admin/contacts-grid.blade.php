                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);"
                                            class="text-dark">David McHenry</a></h5>
                                    <p class="text-muted">UI/UX Designer</p>

                                    <div>
                                        <a href="javascript: void(0);" class="badge bg-primary font-size-11 m-1">Photoshop</a>
                                        <a href="javascript: void(0);"
                                            class="badge bg-primary font-size-11 m-1">illustrator</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">Frank
                                            Kirk</a></h5>
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript: void(0);" class="badge bg-primary font-size-11 m-1">2 +
                                            more</a>
                                    </div>
                                </div>
                                <div class="card-footer bg-transparent border-top">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);"
                                            class="text-dark">Rafael Morales</a></h5>
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript: void(0);"
                                            class="badge bg-primary font-size-11 m-1">Python</a>
                                    </div>
                                </div>
                                <div class="card-footer bg-transparent border-top">
                                    <div class="contact-links d-flex font-size-20">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">Mark
                                            Ellison</a></h5>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">Minnie
                                            Walter</a></h5>
                                    <p class="text-muted">Frontend Developer</p>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);"
                                            class="text-dark">Shirley Smith</a></h5>
                                    <p class="text-muted">UI/UX Designer</p>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <div class="avatar-sm mx-auto mb-4">
                                        <span
                                            class="avatar-title rounded-circle bg-info-subtle text-info font-size-16">
                                            J
                                        </span>
                                    </div>
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">John
                                            Santiago</a></h5>
                                    <p class="text-muted">Full Stack Developer</p>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">Colin
                                            Melton</a></h5>
                                    <p class="text-muted">Backend Developer</p>
                        ...
                        <div class="col-12">
                            <div class="text-center my-3">
                                <a href="javascript:void(0);" class="text-success"><i
                                        class="bx bx-hourglass bx-spin me-2"></i> Load more </a>
                            </div>
                        </div> <!-- end col-->
                    </div>
                    <!-- end row -->
