                                            ...
                                            <ul class="list-unstyled categories-list">
                                                <li>
                                                    <div class="custom-accordion">
                                                        <a class="text-body fw-medium py-1 d-flex align-items-center"
                                                            ...
                                                            Files <i class="mdi mdi-chevron-up accor-down-icon ms-auto"></i>
                                                        </a>
                                                ...
                                                <li>
                                                    <a href="javascript: void(0);"
                                                        ...
                                                        <i class="mdi mdi-google-drive font-size-16 text-muted me-2"></i>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="overflow-hidden me-auto">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">12 Files
                                                                        </p>
                                                                    </div>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="overflow-hidden me-auto">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">20 Files
                                                                        </p>
                                                                    </div>
                                                                    <div class="align-self-end ms-2">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="overflow-hidden me-auto">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">06 Files
                                                                        </p>
                                                                    </div>
                                                                    <div class="align-self-end ms-2">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="overflow-hidden me-auto">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">08 Files
                                                                        </p>
                                                                    </div>
                                                                    <div class="align-self-end ms-2">
