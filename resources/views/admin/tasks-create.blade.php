                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Any single <code class="highlighter-rouge">.btn</code> can be
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">The best part is you can do this with any button variant,
                                    too:</p>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="dropdown-header noti-title">
                                                <h5 class="font-size-13 text-muted text-truncate mn-0">Welcome Jessie!
                                                </h5>
                                            </div>
                                            <!-- item-->
                                            <a class="dropdown-item" href="#">Action</a>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Opt into darker dropdowns to match a dark navbar or custom
                                    style by adding <code>.dropdown-menu-dark</code> onto an existing
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary dropdown-toggle"
                                            ...
                                            Left-aligned but right aligned when large screen <i
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary dropdown-toggle"
                                            data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                            Right-aligned but left aligned when large screen <i
                                                class="mdi mdi-chevron-down"></i>
                                        </button>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">By default, the dropdown menu is closed when clicking inside
